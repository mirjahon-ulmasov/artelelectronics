...
import { CustomSelect, CustomBreadcrumb, CustomUpload, CustomDatePicker, StatusSelect, StyledTextL1 } from 'components'
...
export default function EditProduct() {
    ...
    const { data: client, isError } = useFetchClientQuery(airCondID as string)
    ...
    function changeImage(data: UploadChangeParam<UploadFile<any>>) {
        ...
        addClientImage({ 
            customer: parseInt(airCondID as string, 10), 
    ...
    const onFinish = (values: any) => {
        ...
        editClient(data)
            ...
            .then(() => {
                ...
                navigate(`/client/${airCondID}/detail`)
            })
        ...
        <>
            <CustomBreadcrumb
                items={[
                    ...
                    { title: client?.full_name ?? '-', link: `/client/${airCondID}/detail` },
            ...
            >
                ...
                <div style={{ marginTop: '1rem' }}>
                    <Space size='large'>
                        ...
                        <Button size='large' onClick={() => navigate(`/client/${airCondID}/detail`)}>
                            Bekor qilish
                        </Button>
                    </Space>
                </div>
