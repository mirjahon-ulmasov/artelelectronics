...
import { 
    ...
    StyledTextL1, StyledTextL2, Tabs
} from 'components';
...
export function DebtPage() {
    ...
    const [activeTab, setActiveTab] = useState(DEBT.GORENTY_DEBTS)
    ...
    const tabs = [
        { value: DEBT.GORENTY_DEBTS, title: 'Gorenty qarzdorligi'},
        { value: DEBT.GORENTY_OWES, title: 'Gorentyga qarzdorlar'},
    ]
    ...
    return (
        <>
            ...
            <LargeLabel className='mt-2'>
                <Space size='large'>
                    <Space size='small'>
                        <StyledTextL1>Investorlardan qarzdorlik:</StyledTextL1>
                        <StyledTextL2>30 000 000 so’m</StyledTextL2>
                    </Space>
                    <Space size='small'>
                        <StyledTextL1>Mijozlardan qarzdorlik:</StyledTextL1>
